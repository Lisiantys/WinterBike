<x-guest-layout>
    <section class="min-h-screen flex bg-neutral-200 dark:bg-neutral-700">
        <div class="rounded-lg h-5/6 sm:h-full bg-white shadow-lg dark:bg-neutral-800 w-11/12 md:w-8/12  lg:w-10/12 xl:w-8/12 mx-auto my-auto flex items-center justify-center">
            <div class="flex flex-col lg:flex-row-reverse lg:flex-wrap">
                <!-- Colonne de gauche -->
                <div class="py-8 md:py-0 px-2 md:px-0 lg:w-5/12">
                    <div class="p-2 mx-2 sm:mx-8 md:mx-0 2xl:mx-4 md:p-12">
                        <div class="pb-6 pt-0">
                        ...
                        <div class="mb-4 text-sm text-gray-600 mt-6">
                            {{ __('Merci de vous être inscrit(e) ! Avant de commencer, pourriez-vous vérifier votre adresse e-mail en cliquant sur le lien que nous venons de vous envoyer par e-mail ? Si vous n\'avez pas reçu l\'e-mail, nous serons heureux de vous en renvoyer un autre.') }}
                        </div>
                        ...
                        <div class="mt-8 space-y-2">
                            <form method="POST" action="{{ route('verification.send') }}">
                                ...
                                <div class="mb:0 sm:mb-2 pb-1 pt-1 text-center">
                                    <x-primary-button class="bg-gradient-to-r from-blue-500 to-green-500">
                                        {{ __('Renvoyer un e-mail') }}
                                    </x-primary-button>
                                </div>
                            </form>
                ...
                <!-- Colonne de droite -->
                <div class="hidden px-4 py-6 md:px-6 md:py-12 lg:flex items-center rounded-b-lg lg:w-7/12 lg:rounded-l-lg lg:rounded-br-none bg-gradient-to-r from-blue-500 to-green-500">
