            ...
            <div class="flex flex-col lg:flex-row lg:flex-wrap">
                ...
                <div class="px-4 md:px-0 lg:w-6/12">
                    ...
                    <form class="mt-8 space-y-6" method="POST" action="{{ route('login') }}">
                        ...
                        <x-primary-button class="flex justify-center w-full bg-gradient-to-r from-blue-500 to-green-500">
                            {{ __('Connexion') }}
                        </x-primary-button>
                    ...
                    <div class="flex items-center justify-between pb-6">
                        ...
                        <x-primary-button href="{{ route('register') }}" class="bg-gradient-to-r from-blue-500 to-green-500">S'enregister</x-primary-button>
                    </div>
                    </div>
                </div>
                <!-- Colonne de droite -->
