<div class="bg-white shadow-lg rounded-lg border h-full border-gray-200">
    <div class="flex flex-row justify-between items-center h-full">
        ...
        <a href="{{ route('events.show', $event->id) }}" class="flex-grow my-2">
            <h2 class="block text-lg md:text-xl leading-tight font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-green-500 hover:underline">{{ Str::limit($event->name , $limit = 30, $end = '...') }}</h2>
